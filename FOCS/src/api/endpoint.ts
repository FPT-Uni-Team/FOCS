...
const endpoints = {
  ...
  auth: {
    ...
    signUp: () => `${API_BASE_URL}/me/admin/register`,
  ...
  brand: {
    create: () => `${API_BASE_URL}/admin/brand`,
    list: () => `${API_BASE_URL}/admin/brands`,
    detail: (id: string) => `${API_BASE_URL}/admin/brand/${id}`,
    update: (id: string) => `${API_BASE_URL}/admin/brand/${id}`,
    delete: (id: string) => `${API_BASE_URL}/admin/brand/${id}`,
  },
  store: {
    create: () => `${API_BASE_URL}/admin/store`,
    list: () => `${API_BASE_URL}/admin/stores`,
    detail: (id: string) => `${API_BASE_URL}/admin/store/${id}`,
